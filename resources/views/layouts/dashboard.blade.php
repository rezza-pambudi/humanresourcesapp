                    ...
                    <ul class="menu">
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="{{ route('tasks.index') }}" class="submenu-link">List</a>
                                </li>

                                <li class="submenu-item ">
                                    <a href="{{ route('tasks.create') }}" class="submenu-link">Create</a>
                                </li>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item ">
                                    <a href="{{ route('employees.index') }}" class="submenu-link">List</a>
                                </li>

                                <li class="submenu-item ">
                                    <a href="{{ route('employees.create') }}" class="submenu-link">Create</a>
                                </li>
